...
import { userRegister , loginUser, logoutUser, currentUser, updateProfile, verifyEmail, updatePassword , resetPassword, forgotPassword, resendEmailVerificationLink } from "../controllers/user.controller.js";
import { authenticate } from "../middlewares/auth.middleware.js";
import { validate } from "../middlewares/validate.middleware.js";
import { registerSchema, updatePasswordSchema, forgotPasswordSchema, resetPasswordSchema, resendEmailVerificationLinkSchema } from "../validators/user.validator.js";
